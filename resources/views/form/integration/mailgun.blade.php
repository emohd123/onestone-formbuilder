            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        {{ Form::email('mailgun_email[]', isset($mailgunJson['mailgun_email']) ? $mailgunJson['mailgun_email'] : null, ['class' => 'form-control', 'required', 'id' => 'mailgun_email' . $mailgunJsonkey, 'placeholder' => __('Enter mailgun domain')]) }}
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        {{ Form::label('mailgun_mail_from_address' . $mailgunJsonkey, __('Mailgun Mail From Address'), ['class' => 'form-label']) }}
                        {{ Form::text('mailgun_mail_from_address[]', isset($mailgunJson['mailgun_mail_from_address']) ? $mailgunJson['mailgun_mail_from_address'] : null, ['class' => 'form-control', 'required', 'id' => 'mailgun_mail_from_address' . $mailgunJsonkey, 'placeholder' => __('Enter mailgun mail from address')]) }}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
