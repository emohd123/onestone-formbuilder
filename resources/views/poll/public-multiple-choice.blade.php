...
@section('content')
                        ...
                        <div class="card-footer">
                            <div class="text-end btn-mobile-view">
                                ...
                                @if ($poll->results_visibility == 'always_public')
                                    <a href="{{ route('poll.public.result', $id) }}" class="btn btn-success"><i
                                ...
                                @else
                                @endif
                                <a class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                    title="share" href="javascript:void(0);" id="share-poll"
                                    data-share="{{ route('poll.share', $id) }}"><i class="me-2"
    ...
    <div class="m-auto form-group col-lg-5">
