                    ...
                    <div class="card-body">
                        ...
                        <div id="Multiple_choice" class="">
                            ...
                            <div id="require_participants_names" class="{{ 'd-none' }}">
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        {{ Form::label('multi_choice_hide_participate', __('Hide Participants From Each Other'), ['class' => 'Hide participants from each other d-block']) }}
                                    </div>
                                    <div class="col-md-4">
                                        <label class="mt-2 form-switch float-end custom-switch-v1">
                        ...
                        <div id="Meeting_poll" class="d-none">
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    {{ Form::label('meeting_poll_limit_section', __('Limit selection to one option only'), ['class' => 'form-label d-block']) }}
                                </div>
                                <div class="col-md-4">
                                    <label class="mt-2 form-switch float-end custom-switch-v1">
                                        <input type="checkbox" name="limit_selection_to_one_option_only"
                                            id="meeting_poll_limit_section" class="form-check-input input-primary"
                                            {{ 'unchecked' }}>
                                    </label>
                                </div>
                            </div>
                            <div class="mt-2 row">
                                <div class="form-group">
                                    ...
                                    <label class="mt-2 form-switch float-end custom-switch-v1">
                                        <input type="checkbox" name="meeting_set_end_date" id="meeting_poll_set_end_date"
                                            class="form-check-input input-primary" {{ 'unchecked' }}>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    {{ Form::label('meeting_poll_hide_participants_from_each_othe', __('Hide Participants From Each Other'), ['class' => 'form-label d-block']) }}
                                </div>
                                <div class="col-md-4">
                                    <label class="mt-2 form-switch float-end custom-switch-v1">
