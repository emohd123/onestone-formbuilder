                                                ...
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img class="img-fluid d-block" height="200"
                                                            src="{{ Storage::exists($option->image) ? Storage::url($option->image) : Storage::url('not-exists-data-images/200x100.png') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card-footer">
                        <div class="text-end btn-mobile-view">
                            ...
                            <a class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="share"
                                ...
                                data-share="{{ route('poll.share.image', $id) }}"><i class="me-2"
