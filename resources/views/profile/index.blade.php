            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <div id="useradd-2" class="card">
                        ...
                        {!! Form::open(['route' => ['profile.update'], 'method' => 'POST', 'data-validate']) !!}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="country" class="form-control form-control-inline-block" data-trigger id="choices-single-default">
                                            @foreach (\App\Core\Data::getCountriesList() as $key => $value)
                                                <option data-kt-flag="{{ $value['flag'] }}"
                                                    {{ $user->country == $value['name'] ? 'selected' : '' }}
                                                    value="{{ $key }}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div id="avatar-updater" class="col-xs-12 d-none">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                {!! Form::text('avatar-url', route('updateAvatar'), ['class' => 'd-none']) !!}
                                                {!! Form::button(__('Rotate Image'), [
                                                    'class' => 'btn btn-info col-sm-12 mb-1',
                                                    'id' => 'rotate-image',
                                                ]) !!}
                                                ...
                                                {!! Form::button(__('Cancel'), [
                                                    'class' => 'btn btn-danger col-sm-12 mt-1',
                    ...
                    <div id="useradd-3" class="card">
                        ...
                        {!! Form::open(['route' => ['update.login'], 'method' => 'POST', 'data-validate']) !!}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    ...
                                    <div class="tab-pane" id="tfa-settings" role="tabpanel"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            @elseif(!auth()->user()->loginSecurity->google2fa_enable)
                                                ...
                                                {!! Form::open(['route' => 'enable2fa', 'method' => 'POST', 'data-validate']) !!}
                                                <div class="row">
                                                ...
                                                <div>
                                                    <button type="submit"
                                                        class="btn btn-primary float-end">{{ __('Enable 2FA') }}</button>
                                                    {!! Form::close() !!}
                                                </div>
                                                <!--=============Enable Google 2FA Authentication=============-->
                                            @elseif(auth()->user()->loginSecurity->google2fa_enable)
                                                <!--=============Disable Google 2FA Authentication=============-->
                                                {!! Form::open(['route' => 'disable2fa', 'method' => 'POST', 'data-validate']) !!}
                                                ...
                                                <div>
                                                    <button type="submit"
                                                        class="btn btn-danger float-end">{{ __('Disable 2FA') }}</button>
                                                </div>
                                                {!! Form::close() !!}
                                                <!--=============Disable Google 2FA Authentication=============-->
                                            @endif
                        ...
                        <div class="card-footer">
                            <div class="mb-3 col-sm-auto text-sm-end d-flex float-end">
                                @if ($user->active_status == 1)
                                    {!! Html::link(route('profile.status'), __('Deactivate'), [
...
@push('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            window.setTimeout(function() {}, 9e3), $("#dataTable").DataTable(), $image_crop = $(".image-preview")
                .croppie({
                    enableExif: !0,
                    enforceBoundary: !1,
                    enableOrientation: !0,
