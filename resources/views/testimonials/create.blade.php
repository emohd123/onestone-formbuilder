...
@section('breadcrumb')
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Create Testimonial') }}</h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">{!! Html::link(route('home'), __('Dashboard'), ['']) !!}</li>
            <li class="breadcrumb-item">{!! Html::link(route('testimonials.index'), __('Testimonial'), ['']) !!}</li>
                ...
                <div class="card ">
                    ...
                    <div class="card-footer">
                        <div class="btn-flt float-end mb-3">
                            {!! Html::link(route('testimonials.index'), __('Cancel'), ['class' => 'btn btn-secondary']) !!}
