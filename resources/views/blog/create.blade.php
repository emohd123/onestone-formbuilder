...
@section('breadcrumb')
    <div class="col-md-12">
        ...
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('blogs-category.index') }}">{{ __('Blog') }}</a></li>
...
@section('content')
    <div class="row">
        <div class="m-auto col-xl-8 col-lg-8 col-md-6 col-sm-12">
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('category', $categories, null, ['class' => 'form-control', 'required', 'data-trigger']) !!}
                            </div>
                        </div>
                        <div class="form-group">
