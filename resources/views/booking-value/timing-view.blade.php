                                        ...
                                        @elseif($row->type == 'selfie')
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    @if (Utility::fileSystemSettings('storage_type') == 'local')
                                                        <img
                                                            src=" {{ Illuminate\Support\Facades\File::exists(Storage::path($row->value)) ? Storage::url($row->value) : Storage::url('not-exists-data-images/78x78.png') }}"class="mb-2 img-responsive img-thumbnailss">
                                                    @else
                                                        <img
                                                            src=" {{ Storage::path($row->value) }}"class="mb-2 img-responsive img-thumbnailss">
                                                    @endif
                                                    <br>
                                                    <a href="{{ route('selfie.image.download', $bookingValue->id) }}">
                                                        <button class="p-2 btn btn-primary"
                            ...
                            <div class="d-flex flex-column">
                                <p class="mb-0 d-flex align-items-center justify-content-between text-muted">
                                    <strong>{{ __('Date') }}:</strong><strong
                                        class="ms-sm-2 text-body">{{ Utility::dateFormat($bookingValue->booking_slots_date) }}</strong>
                                </p>
                            </div>
