                            ...
                            @if ($form->json != '')
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12 p-4">
                                            <div class="btn-addnew-project text-center">
                                                <div class="card-body">
                                                    ...
                                                    <img src="{{ Illuminate\Support\Facades\File::exists(Storage::path($form->logo)) ? Utility::getpath($form->logo) : Storage::url('not-exists-data-images/78x78.png') }}"
                                ...
                                @else
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12 p-4">
                                        <div class="btn-addnew-project text-center">
                                            <div class="card-body">
                                                <img src="{{ isset($form->logo) ? Storage::url($form->logo) : Storage::url('not-exists-data-images/78x78.png') }}"
                                                    width="100px" class="mb-5">
                                                <h4 class="text-muted mt-2">{{ $form->title }}</h4>
                                            </div>
                                            <div class="card-footer">
