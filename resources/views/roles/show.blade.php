                                        ...
                                        @if ($module != 'module')
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        @php
                                                            $defaultPermissions = ['manage', 'create', 'edit', 'delete', 'view', 'impersonate', 'fill', 'design', 'show', 'download', 'duplicate', 'theme-setting', 'integration', 'payment', 'vote', 'result', 'phone-verified', 'email-verified', 'plan-upgrade', 'document-generate'];
                                                        @endphp
