...
# {{ $bookingValue->Booking->business_name }}
...
{!! Form::image(asset('storage/app/' . $bookingValue->Booking->business_logo),null, ['id'=>'app-dark-logo','class'=>'img img-responsive my-5 w-30 justify-content-center text-center']) !!}
</div>
@endif
...
<td>
{{ Utility::dateFormat($bookingValue->booking_slots_date) }}
</td>
</tr>
<tr>
<td>
...
<td>
{{ Utility::dateFormat($bookingValue->booking_seats_date) }}
</td>
</tr>
<tr>
<td>
...
<td>
{{ $bookingValue->booking_seats_session }}
</td>
</tr>
<tr>
<td>
...
<td>
{{ $bookingValue->booking_seats }}
</td>
</tr>
@endif
@foreach ($bookingValueArray as $rows)
