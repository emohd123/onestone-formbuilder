        ...
        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
            @if (Auth::user()->type == 'Admin')
                <div class="form-group">
                    ...
                    <div class="error-message" id="bouncer-error_user[]"></div>
                </div>
            @endif
        </div>
        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
            <div class="form-group">
                ...
                {{ Form::text('title', null, ['class' => 'form-control','required', 'placeholder' => __('Enter event title')]) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('start_date', __('Start Date'), ['class' => 'form-label']) }}
                {{ Form::text('start_date', $startDate, ['class' => 'form-control','required', 'placeholder' => __('Enter start date'), 'id' => 'start_date']) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('end_date', __('End Date'), ['class' => 'form-label']) }}
                {{ Form::text('end_date', $endDate, ['class' => 'form-control','required', 'placeholder' => __('Enter end date'), 'id' => 'end_date']) }}
            </div>
        </div>
        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
            <div class="form-group">
                ...
                <div class="btn-group-toggle btn-group-colors event-tag" data-toggle="buttons">
                    <label class="p-3 btn bg-info"><input type="radio" name="color"
                            value="event-info" checked class="d-none"></label>
                    <label class="p-3 btn bg-warning"><input type="radio" name="color"
                            value="event-warning" class="d-none"></label>
                    <label class="p-3 btn bg-danger"><input type="radio" name="color"
                            value="event-danger" class="d-none"></label>
                    <label class="p-3 btn bg-success"><input type="radio" name="color"
                            value="event-success" class="d-none"></label>
                    <label class="p-3 btn bg-primary"><input type="radio" name="color" class="d-none"
