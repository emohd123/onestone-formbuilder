...
@push('script')
    ...
    <script>
            ...
            $(".sortable").sortable({
                stop: function() {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        success: function(data) {
                            showToStr('Done!', 'Menu updated successfully', 'success');

                        },
                        error: function(data) {
                            showToStr('Done!', 'Menu does not updated', 'success');
        ...
        $(function() {
            //menu create
            $(document).on('click', '.add_docmenu', function() {
                var url = $(this).data('url');
                var modal = $('#common_modal');
                $.ajax({
                    type: "GET",
            ...
            //submenu create
            $(document).on('click', '.add_docsubmenu', function() {
                var url = $(this).data('url');
                var modal = $('#common_modal');
                $.ajax({
                    type: "GET",
