    ...
    <main class="wrapper">
        <div id="app" class="main-body">
            <div class="main-wrapper main-wrapper-1">
                ...
                @include('document.front.document-public-sidebar')
                                                    ...
                                                    @foreach ($array as $key => $row)
                                                            ...
                                                            <section class="page-content">
                                                                <div class="page-block-content">
                                                                    <div class="block-code">
                                                                        <div class="block-code-wrapper"><div class="qbix-code-content js-content" value="{{ $row->data->html }}"> {{ $row->data->html }} </div></div>
                                                        ...
                                                        @elseif($row->type == 'code')
                                                            <section class="page-content">
                                                                <div class="page-block-content">
                                                                    <div class="block-code">
                                                                        <div class="block-code-wrapper"><div class="qbix-code-content-code js-contents" value="{{ $row->data->code }}"> {{ $row->data->code }}</div></div>
                                                            ...
                                                            @if (isset($array))
                                                                @foreach ($array as $key => $rows)
                                                                    @if ($rows->type == 'heading')
                                                                        @if ($rows->data->level == 1)
                                                                            <li class="list-item">
                                                                                <a class="link-head" class="link-head"
                                                                                    href="{{ Request::url('') . '#' . Str::slug(html_entity_decode($rows->data->text)) }}"
                                                                                    data-scroll="tab-1">
                                                                                    {!! $rows->data->text !!}
                                                                                </a>
