        ...
        <div class="col-sm-8 m-auto">
            <div class="card text-center">
                <div class="card-header">
                    ...
                    <p class="card-subtitle text-muted">{{ __('Start Date') }} : {{ Utility::dateTimeFormat($showAnnouncement->start_date) }}</p>
                    <p class="card-subtitle text-muted">{{ __('End Date') }} : {{ Utility::dateTimeFormat($showAnnouncement->end_date) }}</p>
                </div>
                <div class="card-body">
