...
@section('breadcrumb')
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Testimonial Setting') }}</h4>
        </div>
        <ul class="breadcrumb">
                    ...
                    <div class="card">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="apps-setting" role="tabpanel"
                                ...
                                {!! Form::open([
                                    'route' => ['landing.testimonials.store'],
                                    'method' => 'Post',
                                    'id' => 'froentend-form',
                                        ...
                                        <div class="col-lg-4 d-flex justify-content-end">
                                            <div class="form-switch custom-switch-v1 d-inline-block">
                                                {!! Form::checkbox(
                                                    ...
                                                    null,
                                                    Utility::keysettings('testimonial_setting_enable', 1) == 'on' ? true : false,
                                                    [
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('testimonial_name', Utility::keysettings('testimonial_name', 1), [
                                                    'class' => 'form-control',
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('testimonial_bold_name', Utility::keysettings('testimonial_bold_name', 1), [
                                                    'class' => 'form-control',
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::textarea('testimonial_detail', Utility::keysettings('testimonial_detail', 1), [
                                                    'class' => 'form-control',
                                                    'rows' => 3,
