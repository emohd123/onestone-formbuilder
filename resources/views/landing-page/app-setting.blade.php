                                        ...
                                        <div class="col-lg-4 d-flex justify-content-end">
                                            <div class="form-switch custom-switch-v1 d-inline-block">
                                                {!! Form::checkbox(
                                                    'apps_setting_enable',
                                                    null,
                                                    Utility::keysettings('apps_setting_enable', 1) == 'on' ? true : false,
                                                    [
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('apps_name', Utility::keysettings('apps_name', 1), [
                                                    'class' => 'form-control',
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('apps_bold_name', Utility::keysettings('apps_bold_name', 1), [
                                                    'class' => 'form-control',
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::textarea('app_detail', Utility::keysettings('app_detail', 1), [
                                                    'class' => 'form-control',
                                                    'rows' => '3',
