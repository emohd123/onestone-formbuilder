                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                {{ Form::label('business_growth_front_image', __('Image'), ['class' => 'form-label']) }}
                                                *
                                                {!! Form::file('business_growth_front_image', [
                                                    'class' => 'form-control',
                                                    'id' => 'business_growth_front_image',
                                                ]) !!}
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a href="javascript:void(0);" data-url="{{ route('business.growth.view.create') }}"
                                        ...
                                        class="mx-1 btn btn-sm btn-primary business_growth_view_create"
                                    ...
                                    <tbody>
                                        @if (is_array($businessGrowthViewSettings) || is_object($businessGrowthViewSettings))
                                            ...
                                            @foreach ($businessGrowthViewSettings as $key => $businessGrowthViewSetting)
                                                <tr>
                                                    <td>{{ $ffNo++ }}</td>
                                                    <td>{{ $businessGrowthViewSetting['business_growth_view_name'] }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <span>
                                                            <a href="javascript:void(0);"
                                                                ...
                                                                class="mx-1 btn btn-sm btn-primary business_growth_edit"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a href="javascript:void(0);" data-url="{{ route('business.growth.create') }}"
                                        data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        class="mx-1 btn btn-sm btn-primary business_growth_create"
                                        data-bs-original-title="{{ __('Create') }}">
                                        <i class="ti ti-plus text-light"></i>
                                    </a>
                                </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.business_growth_create', function() {
        ...
        $(document).ready(function() {
            $(document).on('click', '.business_growth_edit', function() {
                var action = $(this).data('url');
                var modal = $('#common_modal');
                $.get(action, function(response) {
        ...
        $(document).ready(function() {
            $(document).on('click', '.business_growth_view_create', function() {
                var action = $(this).data('url');
                var modal = $('#common_modal');
                $.get(action, function(response) {
