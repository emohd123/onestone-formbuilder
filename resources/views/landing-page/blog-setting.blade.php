...
@section('title', __('Blog Settings'))
@section('breadcrumb')
<div class="col-md-12">
                                        ...
                                        <div class="col-lg-4 d-flex justify-content-end">
                                            <div class="form-switch custom-switch-v1 d-inline-block">
                                                {!! Form::checkbox(
                                                    'blog_setting_enable',
                                                    null,
                                                    Utility::getsettings('blog_setting_enable',1) == 'on' ? true : false,
                                                    [
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('blog_name', Utility::getsettings('blog_name',1), [
                                                    'class' => 'form-control',
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                {!! Form::textarea('blog_detail', Utility::getsettings('blog_detail',1), [
                                                    'class' => 'form-control',
                                                    'rows' => '3',
