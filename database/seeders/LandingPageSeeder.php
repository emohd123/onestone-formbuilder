...
class LandingPageSeeder extends Seeder
{
    ...
    {
        $settings = [
            ['key' => 'apps_setting_enable', 'value' => 'on', 'created_by' => 1],
            ['key' => 'apps_name', 'value' => 'Prime Laravel', 'created_by' => 1],
            ['key' => 'apps_bold_name', 'value' => 'Form Builder Saas', 'created_by' => 1],
            ['key' => 'app_detail', 'value' => 'Prime Laravel Form Builder Saas is software for creating automated systems, you can create your own forms without writing a line of code. you have only to use the Drag & Drop to build your form and start using it.', 'created_by' => 1],
            ['key' => 'apps_image', 'value' => 'seeder-files/app.png', 'created_by' => 1],
            ['key' => 'apps_multiple_image_setting', 'value' => '[{"apps_multiple_image":"seeder-files/1.png"},
                                                                  {"apps_multiple_image":"seeder-files/2.png"},
                                                                  {"apps_multiple_image":"seeder-files/3.png"},
                                                                  {"apps_multiple_image":"seeder-files/4.png"},
                                                                  {"apps_multiple_image":"seeder-files/5.png"},
                                                                  {"apps_multiple_image":"seeder-files/6.png"},
                                                                  {"apps_multiple_image":"seeder-files/7.png"},
                                                                  {"apps_multiple_image":"seeder-files/8.png"},
                                                                  {"apps_multiple_image":"seeder-files/9.png"}]', 'created_by' => 1],
            ['key' => 'feature_setting_enable', 'value' => 'on', 'created_by' => 1],
            ['key' => 'feature_name', 'value' => 'Prime Laravel Form Builder Saas', 'created_by' => 1],
            ['key' => 'feature_bold_name', 'value' => 'Features', 'created_by' => 1],
            ['key' => 'feature_detail', 'value' => 'Prime Laravel Form Builder Saas The features of Prime make it one of the most flexible systems for optimal inventory management. Features such as godown management, multiple stock valuation, manufacturing, batch and expiry date, job costing, etc., and powerful inventory reports make inventory management a cakewalk.', 'created_by' => 1],
            ['key' => 'feature_setting', 'value' => '[
                {"feature_image":"seeder-files/active.svg","feature_name":"Email Notification","feature_bold_name":"On From Submit","feature_detail":"You can send a notification email to someone in your organization when a contact submits a form. You can use this type of form processing step so that..."},
                {"feature_image":"seeder-files/security.svg","feature_name":"Two Factor","feature_bold_name":"Authentication","feature_detail":"Security is our priority. With our robust two-factor authentication (2FA) feature, you can add an extra layer of protection to your Prime Laravel Form"},
                {"feature_image":"seeder-files/secretary.svg","feature_name":"Multi Users With","feature_bold_name":"Role & permission","feature_detail":"Assign roles and permissions to different users based on their responsibilities and requirements. Admins can manage user accounts, define access level"},
                {"feature_image":"seeder-files/documents.svg","feature_name":"Document builder","feature_bold_name":"Easy and fast","feature_detail":"Template Library: Offer a selection of pre-designed templates for various document types (e.g., contracts, reports).Template Creation: Allow users to create custom templates with placeholders for dynamic content.\r\n\r\nTemplate Library: Offer a selection of pre-designed templates for various document types (e.g., contracts, reports).Template Creation: Allow users to create custom templates with placeholders for dynamic content."}]', 'created_by' => 1],
            ['key' => 'menu_setting_section1_enable', 'value' => 'on', 'created_by' => 1],
            ['key' => 'menu_image_section1', 'value' => 'seeder-files/menusection1.png', 'created_by' => 1],
            ['key' => 'menu_name_section1', 'value' => 'Form Builder Saas', 'created_by' => 1],
            ['key' => 'menu_bold_name_section1', 'value' => 'With Drag & Drop Dashboard Widgets', 'created_by' => 1],
            ['key' => 'menu_detail_section1', 'value' => 'Creating beautiful dashboards has never been easier. Our drag-and-drop interface lets you effortlessly arrange and resize widgets, allowing you to design dynamic and interactive dashboards without any coding.', 'created_by' => 1],
            ['key' => 'menu_setting_section2_enable', 'value' => 'on', 'created_by' => 1],
            ['key' => 'menu_image_section2', 'value' => 'seeder-files/menusection12.png', 'created_by' => 1],
            ['key' => 'menu_name_section2', 'value' => 'Multi builders', 'created_by' => 1],
            ['key' => 'menu_bold_name_section2', 'value' => 'Poll Management & Document Generator & Booking System', 'created_by' => 1],
            ['key' => 'menu_detail_section2', 'value' => 'you can create customized surveys with ease. From multiple choice questions to rating scales, our drag-and-drop builder lets you construct your polls in minutes, saving you valuable time and effort.', 'created_by' => 1],
            ['key' => 'menu_setting_section3_enable', 'value' => 'on', 'created_by' => 1],
            ['key' => 'menu_image_section3', 'value' => 'seeder-files/setting.png', 'created_by' => 1],
            ['key' => 'menu_name_section3', 'value' => 'Setting Features With', 'created_by' => 1],
            ['key' => 'menu_bold_name_section3', 'value' => 'Multiple Section settings', 'created_by' => 1],
            ['key' => 'menu_detail_section3', 'value' => 'A settings page is a crucial component of many digital products, allowing users to customize their experience according to their preferences. Designing a settings page with dynamic data enhances user satisfaction and engagement. Here s a guide on how to create such a page.', 'created_by' => 1],
            ['key' => 'business_growth_setting_enable', 'value' => 'on', 'created_by' => 1],
            ['key' => 'business_growth_front_image', 'value' => 'seeder-files/10.png', 'created_by' => 1],
            ['key' => 'business_growth_video', 'value' => 'seeder-files/video.webm', 'created_by' => 1],
            ['key' => 'business_growth_name', 'value' => 'Makes Quick', 'created_by' => 1],
            ['key' => 'business_growth_bold_name', 'value' => 'Business Growth', 'created_by' => 1],
            ['key' => 'business_growth_detail', 'value' => 'Offer unique products, services, or solutions that stand out in the market. Innovation and differentiation can attract customers and give you a competitive edge.', 'created_by' => 1],
            ['key' => 'business_growth_view_setting', 'value' => '[{"business_growth_view_name":"Positive Reviews","business_growth_view_amount":"20 k+"},{"business_growth_view_name":"Total Sales","business_growth_view_amount":"300 +"},{"business_growth_view_name":"Happy Users","business_growth_view_amount":"100 k+"}]', 'created_by' => 1],
            ['key' => 'business_growth_setting', 'value' => '[{"business_growth_title":"User Friendly"},{"business_growth_title":"Products Analytic"},{"business_growth_title":"Manufacturers"},{"business_growth_title":"Order Status Tracking"},{"business_growth_title":"Supply Chain"},{"business_growth_title":"Chatting Features"},{"business_growth_title":"Workflows"},{"business_growth_title":"Transformation"},{"business_growth_title":"Easy Payout"},{"business_growth_title":"Data Adjustment"},{"business_growth_title":"Order Status Tracking"},{"business_growth_title":"Store Swap Link"},{"business_growth_title":"Manufacturers"},{"business_growth_title":"Order Status Tracking"}]', 'created_by' => 1],
            ['key' => 'faq_setting_enable', 'value' => 'on', 'created_by' => 1],
            ['key' => 'faq_name', 'value' => 'Frequently asked questions', 'created_by' => 1],
            ['key' => 'blog_setting_enable', 'value' => 'on', 'created_by' => 1],
            ['key' => 'blog_name', 'value' => 'BLOGS', 'created_by' => 1],
            ['key' => 'blog_detail', 'value' => 'Optimize your manufacturing business with Digitize, offering a seamless user interface for
            streamlined operations, one convenient platform.', 'created_by' => 1],
            ['key' => 'plan_setting_enable', 'value' => 'on', 'created_by' => 1],
            ['key' => 'plan_name', 'value' => 'Simple, Flexible', 'created_by' => 1],
            ['key' => 'plan_bold_name', 'value' => 'Pricing', 'created_by' => 1],
            ['key' => 'plan_detail', 'value' => 'The pricing structure is easy to comprehend, and all costs and fees are explicitly stated. There
            are no hidden charges or surprise costs for customers.', 'created_by' => 1],
            ['key' => 'testimonial_setting_enable', 'value' => 'on', 'created_by' => 1],
            ['key' => 'testimonial_name', 'value' => 'Simple, Flexible', 'created_by' => 1],
            ['key' => 'testimonial_bold_name', 'value' => 'Our customer say', 'created_by' => 1],
            ['key' => 'testimonial_detail', 'value' => 'Its similar to case studies, but this format allows the company to tell the customers story from their own perspective.', 'created_by' => 1],
            ['key' => 'start_view_setting_enable', 'value' => 'on', 'created_by' => 1],
            ['key' => 'start_view_name', 'value' => 'Prime Laravel Form Builder Saas', 'created_by' => 1],
            ['key' => 'start_view_detail', 'value' => 'Prime Laravel Form Builder Saas is software for creating automated systems, you can create your own forms without writing a line of code. you have only to use the Drag & Drop to build your form and start using it.', 'created_by' => 1],
            ['key' => 'start_view_link_name', 'value' => 'Contact US', 'created_by' => 1],
            ['key' => 'start_view_link', 'value' => url('contact/us'), 'created_by' => 1],
            ['key' => 'start_view_image', 'value' => 'seeder-files/startview.png', 'created_by' => 1],
            ['key' => 'footer_setting_enable', 'value' => 'on', 'created_by' => 1],
            ['key' => 'footer_description', 'value' => 'in this product, we provide you, with form builder & poll management, Multi users & permissions, email notification, event calender with ( google Calendar) And Document Generator.', 'created_by' => 1],
            ['key' => 'background_image', 'value' => 'seeder-files/blog-banner-image.png', 'created_by' => 1],
        ];
        foreach ($settings as $setting) {
            settings::firstOrCreate($setting);
        }

        $parentId1 = FooterSetting::firstOrCreate([
            'menu'      => 'Company',
        ], [
            'slug'      => 'company',
            'parent_id' => 0,
        ...
        $parentId2 = FooterSetting::firstOrCreate([
            'menu'      => 'Product',
        ], [
            'slug'      => 'product',
            'parent_id' => 0,
        ...
        $parentId3 = FooterSetting::firstOrCreate([
            'menu'      => 'Download',
        ], [
            'slug'      => 'download',
            'parent_id' => 0,
        ...
        $parentId4 = FooterSetting::firstOrCreate([
            'menu'      => 'Support',
        ], [
            'slug'      => 'support',
            'parent_id' => 0,
        ...
        $pageSetting14 =   PageSetting::firstOrCreate([
            ...
            'page_url'          => null,
            'friendly_url'      => null,
            'description'       => 'Prime Laravel Form builder Saas Terms and Conditions



                Acceptance of Terms By accessing and using [Prime Laravel Form builder Saas] (the &quot;Service&quot;), you agree to be bound by these terms and conditions. If you do not agree with any part of these terms, please refrain from using the Service.
        ...
        $pageSetting16 = PageSetting::firstOrCreate([
            ...
            'description'   => '
                ...
                Limitation of Liability In no event shall [Prime Laravel Form builder - Saas] be liable for any direct, indirect, incidental, consequential, or punitive damages arising out of or in connection with the use of the Service. This includes but is not limited to any errors or omissions in the content, loss of data, or any other loss or damage.
        ...
        Faq::firstOrCreate([
            ...
            'question'      => 'What is Prime Laravel Form Builder?',
        ...
        Faq::firstOrCreate([
            ...
            'question'      => 'What are the key features of Prime Laravel Form Builder?',
        ...
        Faq::firstOrCreate([
            ...
            'question'      => 'Is Prime Laravel Form Builder compatible with Laravel versions?',
        ...
        Faq::firstOrCreate([
            ...
            'question'      => 'Can Prime Laravel Form Builder handle complex form requirements?',
