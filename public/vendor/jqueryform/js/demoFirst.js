...
jQuery(function ($) {
    ...
    var typeUserAttrs = {};
    const fieldss = ["autocomplete", "button", "checkbox-group", "file", "header", "paragraph", "date", "number", "radio-group", "select", "text", "textarea", "starRating", "spinner", "signaturePad", "break", "location", "color", "video", "selfie"];
