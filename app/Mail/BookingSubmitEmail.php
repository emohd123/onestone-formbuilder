...
class BookingSubmitEmail extends Mailable
{
    ...
    {
        return $this->markdown('emails.booking-submit')->with(['bookingValue' => $this->bookingValue, 'bookingValueArray' => $this->bookingValueArray])->subject('New survey Submited - ' . $this->bookingValue->Booking->business_name);
    }
}
