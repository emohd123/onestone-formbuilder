...
class RolesDataTable extends DataTable
{
    ...
    {
        return $model->newQuery()->where('created_by', Auth::user()->admin_id)->where('name', '!=', 'Super Admin');
    }
    ...
    public function html()
    {
        ...
        if (\Auth::user()->type != 'Super Admin') {
            $buttons[] = ['extend' => 'create', 'className' => 'btn btn-light-primary no-corner me-1 add_role', 'action' => " function ( e, dt, node, config ) {}"];
        }
